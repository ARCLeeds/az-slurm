...
sudo yum -y install /tmp/slurm-17.11.8-1.el7.centos.x86_64.rpm  /tmp/slurm-example-configs-17.11.8-1.el7.centos.x86_64.rpm /tmp/slurm-libpmi-17.11.8-1.el7.centos.x86_64.rpm /tmp/slurm-pam_slurm-17.11.8-1.el7.centos.x86_64.rpm /tmp/slurm-slurmd-17.11.8-1.el7.centos.x86_64.rpm
